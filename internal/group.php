            ...
            <div class="card cbg2 p-2">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="col-4 d-flex justify-content-end">
                        <div>
                            <button class="btn btn-success mx-1 mx-auto" type="button" onclick="window.location.href = 'poll.php?create';"><i class="bi bi-plus-circle"></i></button>
                        </div>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="border-0 actions text-center">
                                        ...
                                        <form action="group.php" method="post" class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            ...
                                            <div class="">
                                                <input type="number" value="<?=$poll['poll_id']?>" name="poll_id" style="display: none;" required>
                                                <button class="btn btn-danger" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas<?=$poll['poll_id']?>" aria-controls="offcanvas<?=$poll['poll_id']?>"><i class="bi bi-trash"></i></button>
