...
if(isset($_POST['action'])) {
    if ($_POST['action'] == 'sel_group') {
        ...
        <div class="container p-3">
            ...
            <div class="">
                <h1 class="text-center">https://wahliomat.de/poll.php?uni=<?=$poll['poll_unique']?></h1>
            </div>
            <script type="text/javascript">
            var qrcode = new QRCode(document.getElementById("qrcode"), {
                text: "https://wahliomat.de/poll.php?uni=<?=$poll['poll_unique']?>",
                width: 512,
                height: 512,
                colorDark : "#000000",
                colorLight : "#ffffff",
            ...
            <div class="card cbg2 p-2">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="col-4 d-flex justify-content-end">
                        <div>
                            <button class="btn btn-success mx-1 mx-auto" type="button" onclick="window.location.href = 'poll.php?create';"><i class="bi bi-plus-circle text-light"></i></button>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            <?php foreach ($polls as $poll): ?>
                                <tr>
                                    ...
                                    <td class="border-0 text-center">
                                        <div>https://wahliomat.de/poll.php?uni=<?=$poll['poll_unique']?></div>
                                    </td>
                                    <td class="border-0 actions text-center">
                                        ...
                                        <form action="group.php" method="post" class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            <div>
                                                ...
                                                <button type="submit" name="action" value="qrcode" class="btn btn-kolping"><i class="bi bi-qr-code-scan text-light"></i></button>
                                            </div>
                                            <div class="">
                                                <input type="number" value="<?=$poll['poll_id']?>" name="poll_id" style="display: none;" required>
                                            ...
                                            <div class="">
                                                <input type="number" value="<?=$poll['poll_id']?>" name="poll_id" style="display: none;" required>
                                                <button class="btn btn-danger" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas<?=$poll['poll_id']?>" aria-controls="offcanvas<?=$poll['poll_id']?>"><i class="bi bi-trash text-light"></i></button>
